...
```{r  echo=FALSE, out.width = '10%', fig.pos="h", fig.align='left'}
...
```{r  echo=FALSE, out.width = '10%', fig.pos="h", fig.align='left'}
knitr::include_graphics("./images/DataCamp.png")
```
...
* [Normal Distribution Calculator (running on Appalachian's Shiny server)](https://mathr.math.appstate.edu/shiny/NormApp3/)
* [Normal Distribution Calculator (running on RStudio Shiny Apps server)](https://alanarnholt.shinyapps.io/norm_area2/)
* [Normal Distribution Calculator (running on Alan's Droplet)](http://alanarnholt.com/shiny/NormalApp/)
* [Normal Distribution Calculator (with more features running on Alan's Droplet)](http://alanarnholt.com/shiny/NormApp3/)
* [Sampling Distributions (running on Alan's Droplet)](http://alanarnholt.com/shiny/SamplingDist/)
...
```{r  echo=FALSE, out.width = '10%', fig.pos="h", fig.align='left'}
knitr::include_graphics("./images/linux2.png")
```
...
Melissa Lee](https://ubc-dsci.github.io/introduction-to-datascience/)
